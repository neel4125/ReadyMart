...
import com.codecoy.ecommerce.adminmodule.adapter.MainCategoryAdapter;
...
public class Main_Cat_Activity extends AppCompatActivity implements MainCategoryAdapter.CallbackInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("MainCatImages");
        init();
        ...
        btn_addMainCat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    Toast.makeText(getApplicationContext(), "Please enter Main Categorey! ...", Toast.LENGTH_LONG).show();
                    return;
                }
               else {
    ...
    private void saveProduct(final String name) {
        ...
        if (imageUri != null) {
            ...
            storageReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            data.put("main_cat_name", name);
                            data.put("main_cat_image", imageUrl);

                            db.collection("Db").document(name).set(data, SetOptions.merge())
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {

                                            progressDialog.dismiss();
                                            final PrettyDialog pDialog = new PrettyDialog(Main_Cat_Activity.this);
                                            pDialog
                                                    .setTitle("Add Main Categorey")
                                                    .setMessage("Main Categorey  Saved")
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    pDialog
                                            .setTitle("Add Main Categorey")
                                            .setMessage("Main Categorey Not Saved")
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Main_Cat_Activity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                    final PrettyDialog pDialog = new PrettyDialog(Main_Cat_Activity.this);
                    pDialog
                            .setTitle("Add Main Categorey")
            ...
            Toast.makeText(Main_Cat_Activity.this, "No Image selected", Toast.LENGTH_SHORT).show();
        }
    }
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            //  Toast.makeText(Main_Cat_Activity.this, ""+e, Toast.LENGTH_SHORT).show();
                                            progressDialog.dismiss();
                                            final PrettyDialog pDialog = new PrettyDialog(Main_Cat_Activity.this);
                                            pDialog
                                                    .setTitle("Add Main Categorey")
