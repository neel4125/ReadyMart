...
import com.codecoy.ecommerce.adminmodule.ProductActivity;
...
public class SubCategoryAdapter extends RecyclerView.Adapter<MainCategoryViewHolder> {
        ...
        holder.btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listDataArrayList.size() > 0) {
                    db.collection("Db").document(listDataArrayList.get(position).getMain_cat_name()).collection("SubCat").document(listDataArrayList.get(position).getDocid())
