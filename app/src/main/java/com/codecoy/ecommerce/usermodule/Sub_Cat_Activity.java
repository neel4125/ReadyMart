...
import com.codecoy.ecommerce.usermodule.adapter.SubCategoryAdapter;
...
public class Sub_Cat_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("");
        setContentView(R.layout.activity_sub__cat_);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            productAdapter = new ProductAdapter(Sub_Cat_Activity.this, productdataList);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent _intent = new Intent(Sub_Cat_Activity.this, MyCartActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_home:
                Intent intent = new Intent(Sub_Cat_Activity.this, Main_Cat_Activity.class);
            ...
            case R.id.action_logout:
                ...
                startActivity(new Intent(Sub_Cat_Activity.this, LoginActivity.class));
                finishAffinity();
                break;
            case R.id.home:

                startActivity(new Intent(Sub_Cat_Activity.this, Main_Cat_Activity.class));
                finish();
